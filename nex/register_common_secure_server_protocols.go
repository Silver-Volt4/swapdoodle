...
import (
	...
	nex_datastore_super_mario_maker "github.com/silver-volt4/swapdoodle/nex/datastore/super-mario-maker"
)
...
func registerCommonSecureProtocols() {
	...
	smmDatastore := datastoresmm.NewProtocol(globals.HppServer)
	...
	globals.HppServer.RegisterServiceProtocol(smmDatastore)
